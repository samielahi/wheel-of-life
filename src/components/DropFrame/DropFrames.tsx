    ...
    <>
      <div className="w-full flex overflow-x-auto overflow-y-hidden flex-col border-smoke border-b-[3px]">
        <div className="w-max flex">
          ...
          <DropFrame id="006"></DropFrame>
          <DropFrame id="007"></DropFrame>
          <DropFrame id="008"></DropFrame>
          <DropFrame id="009"></DropFrame>
          <DropFrame id="010"></DropFrame>
          <DropFrame id="011"></DropFrame>
          <DropFrame id="012"></DropFrame>
