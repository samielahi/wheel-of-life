...
export default function BurgerMenu(props: { children?: any }) {
  ...
  // Close an open menu once 'md' breakpoint is crossed
  useEffect(() => {
  ...
  return (
    <>
      <button
        ...
        className="absolute left-[calc(100%_-_5rem)] top-[3rem] z-30 outline-offset-2 outline-violet focus:outline-4"
      >
