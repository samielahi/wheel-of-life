    ...
    <>
      {isStatus ? (
        <>
          ...
          ></div>
          <div className="expand z-9999 fixed left-[calc(50%_-_300px)] top-[calc(50%_-_10rem)] h-[300px] w-[32rem] rounded border-4 border-lightViolet bg-active p-8 drop-shadow-lg">
            {props.children}
          </div>
        </>
      ) : (
