    ...
    <>
      {isStatus ? (
        <>
          ...
          ></div>
          <div className="expand z-9999 fixed left-[calc(50%_-_16rem)] top-[calc(50%_-_150px)] h-[300px] w-[32rem] rounded border-4 border-lightViolet bg-active p-8 drop-shadow-lg">
            {props.children}
          </div>
        </>
      ) : (
